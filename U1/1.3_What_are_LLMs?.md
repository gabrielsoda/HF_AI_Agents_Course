...
![The original Transformer architecture looked like this, with an encoder on the left and a decoder on the right.](../images/1transformer_architecture.png)
...
![](../images/2AutoregressionSchema.gif)
...
You can interact with the decoding process yourself with SmolLM2 in this Space (remember, it decodes until reaching an **EOS** token which is  **** for this model):
...
![](../images/4AttentionSceneFinal.gif)
...
To run this notebook https://huggingface.co/agents-course/notebooks/blob/main/unit1/dummy_agent_library.ipynb , **you need a Hugging Face token** that you can get from https://hf.co/settings/tokens.
