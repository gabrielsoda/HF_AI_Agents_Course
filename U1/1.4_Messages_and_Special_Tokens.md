...
I need help with my orderassistant

I'd be happy to help. Could you provide your order number?user

It's ORDER-123assistant
```
...
user
Can you explain what a chat template is?
assistant
A chat template structures conversations between users and AI models...
user
How do I use it ?
```
